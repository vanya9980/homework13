...
public class JsonPlaceholderAPI {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Get and print all open todos for a user
        getAndPrintOpenTodos(1);
...
// Extract the last post ID
    ...
    public static void getAndPrintOpenTodos(int userId) throws IOException {
        // Get user's todos
        URL todosUrl = new URL(BASE_URL + "/users/" + userId + "/todos");
        ...
        String todosResponse = getResponse(todosConn);

        // Filter and print open todos
